...
const Profile = () => {
    ...
    const fetchOrders = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3000/users/${user.id}/orders`
        );
        setOrders(response.data.formattedOrders || []);
      } catch (error) {
  ...
  const getStatusBadge = (status) => {
    const base =
      "px-4 py-2 rounded-full text-sm font-semibold border-2 backdrop-blur-sm";
    switch (status) {
      case "accepted":
      ...
      <div className="max-w-7xl mx-auto p-4">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
                    Welcome back,
                    <br />
                    <span style={{ color: "#C2BBA8" }}>{user?.username}!</span>
                  </h1>
                ...
                >
                  {[
                    ...
                    { icon: Phone, text: user?.phone_number },
                    { icon: MapPin, text: user?.address, colSpan: true },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-4xl font-bold text-[#184227]">Your Orders</h2>
          </div>
                    ...
                    <div className="flex flex-col xl:flex-row gap-8">
                      ...
                      <div className="flex-1 space-y-6">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                          <div>
                            <h3 className="text-3xl font-bold mb-2 text-[#184227]">
                              {item.coffee_name}
                            </h3>
                      ...
                      {/* Coffee Image */}
                      <div className="w-full xl:w-64 h-64 flex-shrink-0">
                        <div
                          className="w-full h-full rounded-2xl overflow-hidden border-4 shadow-2xl"
                          style={{ borderColor: "#83A184" }}
                        >
                          <img
