      ...
      <div className="mx-auto flex w-fit  gap-1 rounded-md pb-20 pt-10 md:gap-2">
        {images.slice(0, maxThumbnails).map((imageUrl, i) => (
          <div
            ...
            className={`group relative h-[448px] overflow-hidden rounded-2xl transition-all duration-300 ${
              selectedIndex === i ? "w-[464px]" : "w-6 sm:w-8 md:w-20 xl:w-40 cursor-pointer"
            }`}
